...
ActiveRecord::Schema.define(version: 20180612105029) do
  ...
  create_table "fundby_promises", force: :cascade do |t|
    t.integer "promise_id"
    t.integer "project_id"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_fundby_promises_on_project_id"
    t.index ["promise_id"], name: "index_fundby_promises_on_promise_id"
    t.index ["user_id"], name: "index_fundby_promises_on_user_id"
  end
