...
User.create(name:"Admin",last_name:"superuser",image:"image.jpg",role:"admin",description:"This user can manage all the web application",email:"admin@user.com",password:"admin1234",password_confirmation:"admin1234")
User.create(name:"User",last_name:"Commonuser",image:"image.jpg",role:"user",description:"This user can t manage all the web application",email:"user@user.com",password:"user1234",password_confirmation:"user1234")
